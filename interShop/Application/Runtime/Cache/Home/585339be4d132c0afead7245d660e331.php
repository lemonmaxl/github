...
<div class="container">
    <div class="order-info mt20">
        <form action="/index.php/Home/Order/add.html" method="post">
            ...
            <div class="clearfix">
                <ul class="payment-list">
                    ...
                    <div><img src="/Public/Home/static/images/pay_alipay.gif"></div>
                    </li>
                </ul>
            </div>
 ...
 $totalPrice = 0; foreach($data as $k => $v){ ?>
           <tr goods_id="<?php echo $v['goods_id'];?>" goods_attr_id_list="<?php echo $v['goods_attr_id_list'];?>">
               ...
               <td class="amount red tr">
                   <?php
 $xj = $v['price'] * $v['goods_number']; $totalPrice += $xj; echo $xj; ?>
               </td>
           </tr>
            <?php } ?>
        </table>
