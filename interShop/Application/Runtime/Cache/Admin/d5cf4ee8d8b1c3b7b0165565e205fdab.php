...
<div class="page-container">
    <form action="/index.php/Admin/Privilege/edit/id/51.html" method="post" class="form form-horizontal" id="form-user-add">
            ...
            <div class="formControls col-xs-6 col-sm-6">
				<span class="select-box">
					<select name="parent_id" class="select">
                        ...
                        <?php
 if($v['id'] == $data['id'] || in_array($v['id'], $children)) continue ; if($v['id'] == $data['parent_id']) $select = 'selected="selected"'; else $select = ''; ?>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['pri_name']; ?>" name="pri_name" style='width:30%'>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>对应的模块名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['module_name']; ?>" name="module_name" style='width:30%'>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>对应的控制器名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['controller_name']; ?>" name="controller_name" style='width:30%'>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>对应的方法名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['action_name']; ?>" name="action_name" style='width:30%'>
            </div>
        </div>
