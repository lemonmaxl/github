...
<div class="page-container">
    <form class="form form-horizontal" id="form-admin-add" method="POST" action="/index.php/Admin/Attribute/add/type_id/5.html" enctype="multipart/form-data">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>属性名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value=""   name="attr_name" style="width: 30%;">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>属性的类型：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="radio" name='attr_type' value="可选" class='radio-box' />可选
                <input type="radio" name='attr_type' value="唯一" class='radio-box' />唯一
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>属性可选值,多个值用,隔开：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value=""   name="attr_option_value" style="width: 30%;">
            </div>
        </div>
        <div class="row cl">
