...
<div class="page-container">
    <form class="form form-horizontal" id="form-admin-add" method="POST" action="/index.php/Admin/Role/add.html">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>角色名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value=""   name="role_name" style="width: 30%;">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <?php echo str_repeat('-',$v['level']*8);?><input type="checkbox" value="<?php echo $v['id'];?>"   name="pri_id[]"  /><?php echo $v['pri_name'];?><br/>
                <?php } ?>
            </div>
        </div>
        <div class="row cl">
